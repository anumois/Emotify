    ...
    try:
        ...
        for member in sOut['HaKeyword']:
            try:
                ...
                try:
                    context['sHaKeyword'].append([member[0],[]])
                except KeyError:
                    pass
        context['sSaKeyword'] = []
        for member in sOut['SaKeyword']:
            try:
                ...
                try:
                    context['sSaKeyword'].append([member[0],[]])
                except KeyError:
                    pass
        ...
        for member in sOut['SuKeyword']:
            try:
                ...
                try:
                    context['sSuKeyword'].append([member[0],[]])
                except KeyError:
                    pass
        ...
        for member in sOut['AnKeyword']:
            try:
                ...
                try:
                    context['sAnKeyword'].append([member[0],[]])
                except KeyError:
                    pass
        ...
        for member in scompOut['HaKeyword']:
            try:
                ...
                try:
                    context['scompHaKeyword'].append([member[0],[]])
                except KeyError:
                    pass
        ...
        for member in scompOut['SaKeyword']:
            try:
                ...
                try:
                    context['scompSaKeyword'].append([member[0],[]])
                except KeyError:
                    pass
        ...
        for member in scompOut['SuKeyword']:
            try:
                ...
                try:
                    context['scompSuKeyword'].append([member[0],[]])
                except KeyError:
                    pass
        ...
        for member in scompOut['AnKeyword']:
            try:
                ...
                try:
                    context['scompAnKeyword'].append([member[0],[]])
                except KeyError:
                    pass
